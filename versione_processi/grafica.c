/* file riguardante tutta la grafica */
...
void sfondo_gioco(bool flags[N_TANE]){
    ...
    for(int y = 5 ; y <= F_TANE; y ++){
        ...
        if(flags[0] == true){ /* la tana è libera */
            attron(COLOR_PAIR(3)) ; 
        ...
        if(flags[1] == true){ /* la tana è libera */
            attron(COLOR_PAIR(3)) ; 
        ...
        if(flags[2] == true){ /* la tana è libera */
            attron(COLOR_PAIR(3)) ; 
        ...
        if(flags[3] == true){ /* la tana è libera */
            attron(COLOR_PAIR(3)) ; 
        ...
        if(flags[4] == true){ /* la tana è libera */
            attron(COLOR_PAIR(3)) ; 
...
void win_screen(int vite, int punteggio[1]){
    ...
    mvprintw((maxy/2)+2, (maxx/2), "SCORE: %d", punteggio[0]) ;
...
void wait_manche_screen(){
    ...
    init_pair(13, COLOR_WHITE, COLOR_BLACK) ; /* colore della scritta */
    ...
    mvprintw(maxy/2, (maxx/2)-14, "--- RIGENERAZIONE MANCHE ---") ;
